...
In the [next post](/posts/recursive-types-and-folds-2b/) we'll step back a bit and spend some time understanding what "fold" really means, and at some guidelines for choosing between `fold`, `foldback` and `cata`.
